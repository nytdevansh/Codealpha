...
int main(){
   ...
   do{
    cout<<"\nWelcome to File Manager Created by Devansh Yadav\n";
    ...
    case 2:
        cout<<"File Name which you want to write on: ";
        cin>>filename;
        write(filename);
        break;
    
    case 3:
        cout<<"File Name which you want to read: ";
        cin>>filename;
        cout<<read(filename);
        break;
    
    case 4:
        cout<<"File Name which you want to delete: ";
        cin>>filename;
        deletef(filename);
        break;
